...
# def add_section(slide, title, text, left, top, width, body_size, title_size):
#     """
#     Helper func to draw a text box with a bold header

#     Args:
#         slide (_type_): _description_
#         title (_type_): title of the research
#         text (_type_): text in the box
#         left (_type_): left position of the text box
#         top (_type_): top position of the text box
#         width (_type_): width of the text box
#     """
#     if not text:
#         return top
...
#     estimated_hei = Inches(1.5) + (len(text) / 50 * Inches(0.3))
