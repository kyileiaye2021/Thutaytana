...
def generate_poster(poster_content, vision_metadata, conference_rules, output_name="Final_Poster.pptx"):
    ...
    Args:
        poster_content (_type_): _description_
        vision_metadata (_type_): _description_
        conference_rules (_type_): _description_
        output_name (str, optional): _description_. Defaults to "Final_Poster.pptx".
    """
    prs = Presentation()
